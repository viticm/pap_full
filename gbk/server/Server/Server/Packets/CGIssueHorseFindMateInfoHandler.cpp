...
uint	CGIssueHorseFindMateInfoHandler::Execute(CGIssueHorseFindMateInfo* pPacket, Player* pPlayer )
{
__ENTER_FUNCTION
	...
	HorseFindMateModule::GetInstance().IssueHorseFindMateInfo(pHuman, pPetDB, pPacket->GetLeaveWords());
