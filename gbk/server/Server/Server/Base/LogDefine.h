...
enum	ITEM_OP_TYPE
{
	...
	ITEM_SELL_SPLITE				=	227,	//玩家出售部分商品
	ITEM_REMOVEITEM_BANK			=	228,	//银行移出物品
	ITEM_REMOVEITEM_BAG				=	229,	//从背包移出物品
	ITEM_GETITEM_BANK				=	230,	//银行获得物品
	ITEM_GETITEM_BAG				=	231,	//背包获得物品
	ITEM_TILED_BANK_DEST			=	232,	//银行物品合并目的
	ITEM_TILED_BANK_SRC				=	233,	//银行物品合并源头
	ITEM_SWITCH_BAGTOBANK			=   234,	//背包交换物品到银行物品
	ITEM_SWITCH_BANKTOBAG			=   235,	//银行交换物品到背包
	ITEM_MOVEITEM_BAGTOBANK			=   236,	//背包物品移动到银行

	ITEM_ADDHOLE_CONSUME			=   250,	//加孔物品消耗
	ITEM_EQUIPLEVELUP_ITEM_CONSUME	=   252,	//升星消耗物品
	ITEM_EQUIPBIND_ITEM_CONSUME		=   253,	//绑定消耗物品
	ITEM_EQUIPCHANGEPAI_ITEM_CONSUME=   254,	//换牌消耗物品
	ITEM_CREATE_FROMMATERIAL		=   255,	//打造
	ITEM_CREATE_MATERIALCONSUME		=   256,	//打造材料消耗
	ITEM_DECOMPOUND_REMOVE			=   257,	//拆解掉
	ITEM_DECOMPOUND_MATERIALGET		=   258,	//拆解获得材料
	ITEM_REMOULD_CONSUME			=   259,	//改造物品消耗
	ITEM_SPECIALREPAIR_CONSUME		=   260,	//特修物品消耗
	ITEM_ADSORBMAGIC_CONSUME		=	261,	//附魔物品消耗
	ITEM_CANCELMAGIC_CONSUME		=	262,	//退魔物品消耗
	
	ITEM_REPAIR						=	310,	//物品修理,
	ITEM_USEGEM_REMOVE				=	319,	//宝石使用时移除
	...
	ITEM_SYSTEM_GIVE_BACK           =	426,	//系统返回
	ITEM_BOX_RECYCLE				=	500,	//ItemBox回收
	
	ITEM_SKILL_USE					=	600,	//技能消耗
	ITEM_SKILL_STUDY				=	601,	//技能学习
	ITEM_DISMANTLE_SOUXIA			=   602,	//拆解捜侠录销毁或者生成
	ITEM_REFINING_SOUXIA			=   603,	//炼化捜侠录销毁或者生成
	ITEM_SEW_SOUXIA					=   604,	//缝合捜侠录销毁或者生成
	ITEM_DESTROY_SOUXIA				=   605,	//NPC删除捜侠录销毁
	ITEM_STUDY_SOUXIA				=   606,	//学习捜侠录销毁
	ITEM_EQUIP_REFINING				=   607,	//装备炼化生成
};
...
enum	MONEY_OP_TYPE
{
	...
	MONEY_LEARN_SKILL_COST				=	123,	//学习战斗技能
	MONEY_SCRIPT_COST					=	130,	//脚本调用金钱消耗
	MONEY_SCRIPT_INCOME					=	131,	//脚本调用金钱收入
	MONEY_DIE_COST						=	132,	//死亡金钱惩罚
	MONEY_PET_COST						=	133,	//宠物金钱消耗
	MONEY_GUILD_CREATE_COST				=	134,	//创建帮会金钱消耗
	MONEY_ADDHOLE_MONEYREDUCE			=   150,    //加孔金钱消耗
	MONEY_EQUIPLEVEL_REDUCE				=   151,	//装备升级消耗金钱
	MONEY_REMOULD_REDUCE			    =   152,	//装备改造金钱消耗
	MONEY_CREATE_REDUCE					=   153,	//装备打造金钱消耗
	MONEY_ADSORBMAIGC_REDUCE			=	154,	//装备附魔金钱消耗
	MONEY_CANCELMAIGC_REDUCE			=	155,	//装备退魔金钱消耗
	MONEY_GM_MODIFY						=	200,	//GM 修改
	MONEY_HORSE_MATTING					=	400,
	MONEY_HORSE_FINDINGMATING			=	401,	// 发布骑乘征友消耗 [6/16/2008 wuwenbin]
...
struct ITEM_LOG_PARAM
{
	...
	ITEM_OP_TYPE	SecOpType;									//转向类型
	BYTE			ContainerPos;								//容器位置
	BYTE			DestContainerPos;							//目标容器位置
	BYTE			Count;										//变化个数
