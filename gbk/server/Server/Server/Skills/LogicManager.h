...
namespace Combat_Module
{
	...
	inline BOOL LogicManager_T<ImpactLogic_T, NUMBER_OF_IMPACT_LOGIC_IDS>::Init(VOID)
	{
		...
		REGISTER_LOGIC(StdImpact080_T);
		REGISTER_LOGIC(StdImpact081_T);		
		REGISTER_LOGIC(StdImpact082_T);
		REGISTER_LOGIC(StdImpact083_T);
		m_bReady = TRUE;
		return TRUE;
		__LEAVE_FUNCTION		
		return FALSE;
		...
		inline BOOL LogicManager_T<SkillLogic_T, MAX_SKILL_LOGIC_ID>::Init(VOID)
	{
		...
		REGISTER_LOGIC(ImpactsToTargetAndSelfForRun_T);
		...
		inline BOOL LogicManager_T<MenPai_T, MenPai_T::NUMBER_OF_MENPAI>::Init(VOID)
	{
		__ENTER_FUNCTION
		//...
		REGISTER_LOGIC(ShaoLinGWS_T);
		REGISTER_LOGIC(ShaoLinTLH_T);
		REGISTER_LOGIC(GaiBangGGB_T);
		REGISTER_LOGIC(GaiBangZGB_T);

		REGISTER_LOGIC(WuDangJWD_T);
		REGISTER_LOGIC(WuDangQWD_T);
		REGISTER_LOGIC(TangMenDT_T);
		REGISTER_LOGIC(TangMenXJT_T);

		REGISTER_LOGIC(XiaoYaoXXY_T);
		REGISTER_LOGIC(XiaoYaoZXY_T);
		REGISTER_LOGIC(YaoWangGuKYW_T);
		REGISTER_LOGIC(YaoWangGuYYW_T);

		REGISTER_LOGIC(TaoHuaGuDTH_T);
		REGISTER_LOGIC(TaoHuaGuYTH_T);
		REGISTER_LOGIC(EMeiCEM_T);
		REGISTER_LOGIC(EMeiFEM_T);
