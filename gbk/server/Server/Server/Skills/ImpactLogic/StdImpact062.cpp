...
namespace Combat_Module
{
	...
	{
		BOOL StdImpact062_T::InitFromData(OWN_IMPACT& rImp, ImpactData_T const& rData) const
		{
			__ENTER_FUNCTION
			InitDamages(rImp);
			return TRUE;
		...
		BOOL StdImpact062_T::RefixPowerByRate(OWN_IMPACT & rImp, INT nRate) const
		{
			__ENTER_FUNCTION
			__LEAVE_FUNCTION
			return TRUE;
		...
		VOID StdImpact062_T::InitDamages( OWN_IMPACT& rImp ) const
		{
			__ENTER_FUNCTION
		...
		VOID StdImpact062_T::OnIntervalOver( OWN_IMPACT& rImp, Obj_Character& rMe ) const
		{
			__ENTER_FUNCTION
		...
		INT StdImpact062_T::GetRifixResult(OWN_IMPACT& rImp, Obj_Character& rMe, Obj_Character& rSender, INT iBase, INT iRefix, INT iRefixType ) const
		{
			__ENTER_FUNCTION
		...
		INT	StdImpact062_T::GetRefixParamValue(OWN_IMPACT& rImp, Obj_Character& rMe, Obj_Character& rSender, INT iRefixType, INT nParamType) const
		{
			__ENTER_FUNCTION
