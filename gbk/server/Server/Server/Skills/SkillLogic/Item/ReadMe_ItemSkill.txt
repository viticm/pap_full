...
--脚本号
g_scriptId = 700001 --临时写这个,真正用的时候一定要改.
...
function OnActivateOnce( sceneId, selfId )
	if(-1~=g_Impact1) then
		LuaFnSendSpecificImpactToUnit(sceneId, nSelfID, nSelfID, nSelfID, g_Impact1, 0);
	end
	Msg2Player( sceneId,selfId,"您已经骑上了....",MSG2PLAYER_PARA) --通知玩家
	return 1;
end
