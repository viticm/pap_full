	...
	namespace Skill_Module
	{
		...
		class SkillLogic_T
		{
			...
			public: //passive skill interface
				...
				VOID BroadcastTargetListMessage(Obj_Character& rMe, 
												OBJLIST& rTargets, 
			...
			protected: //interface for interval using
				...
				//************************************
				// Method:    GetHurtDelayTime
				// 获得伤害或未未命中处理的延迟时间
				//************************************
				INT GetHurtDelayTime( SkillInfo_T &rSkillInfo, Obj_Character &rMe, Obj_Character &rTar ) const;
				...
				BOOL IsCriticalHit(Obj_Character& rMe, INT nCriticalRate, Obj_Character& rTag) const;
