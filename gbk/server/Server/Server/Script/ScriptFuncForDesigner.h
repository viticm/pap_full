脚本系统C导出函数文档	LuaFnTbl_Ability.h
	...
	*		得到玩家身上未绑定物品数
	*/
	该函数注册为 LuaFnGetNotBindItemCountInBody
	...
	*		得到玩家背包中未绑定物品数
	*/
	该函数注册为 LuaFnGetNotBindItemCountInBag
	...
	*		玩家背包中未绑定物品掉落
	*/
	该函数注册为 LuaFnDropNotBindItemInBag
	...
	*		玩家身上未绑定物品掉落
	*/
	该函数注册为 LuaFnDropNotBindItemInBody
...
/****************************************************************************
	 ...
	 *	修改记录：
	*****************************************************************************/
	该函数注册为 LuaFnGetAbilityLevelUpConfig
	...
	*	修改记录：
	*****************************************************************************/
	该函数注册为 LuaFnGetAbilityLevelUpConfig2
...
脚本系统C导出函数文档	LuaFnTbl_DoAction.h
	...
	*****************************************************************************/
	 ...
	 *	修改记录：
	*****************************************************************************/
	该函数注册为 LuaFnGetItemIndexOfUsedItem
...
/** -----------------------------------------------------------------------
    ...
    *				检查系统定时器是否过期
	*/
	该函数注册为 CheckSystemTimerValidity
...
脚本系统C导出函数文档	LuaFnTbl_Relation.h
	...
	*****************************************************************************/
	...
	/****************************************************************************
	 *	开发人员：	王勇鸷
	 *	编写时间：	2008-3-28	20:07
	 *	函数名称：	LuaFnSetDeadLinkFriendPoint
	 *	参数说明：
	 *				sceneId
	 *					场景编号
	 *				selfId
	 ...
	 *
	 *	功能说明：	设置 selfId 与 friendID 的友好度为 friendPoint,
	 *				与LuaFnSetFriendPoint的区别在于好友可以处于离线状态
	 *	修改记录：
	*****************************************************************************/
	该函数注册为 LuaFnSetDeadLinkFriendPoint
	...
	*					好友的GUID
	*
	*	功能说明：	通过好友的GUID将不在线的好友删除
	*	修改记录：
	*****************************************************************************/
	该函数注册为 LuaFnDelFriendByGUID
...
/** -----------------------------------------------------------------------
	...
	*					
	*/
	该函数注册为 LuaFnGetNewSceneInfoByIndex
