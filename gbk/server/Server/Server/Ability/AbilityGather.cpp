...
__ENTER_FUNCTION
	...
	if( pObj==NULL )
	{
		Log::SaveLog( SERVER_LOGFILE, "AbilityGatherMine: not find obj=%d", ItemBoxObjID ) ;
	...
	{
		Log::SaveLog( SERVER_LOGFILE, "AbilityGatherMine: Obj_ItemBox obj	=	%d\r\n  is Not class of ITEM_CLASS_BOX", ItemBoxObjID ) ;
		return OR_INVALID_TARGET ;
	}
...
__ENTER_FUNCTION
	...
	if( pObj==NULL )
	{
		Log::SaveLog( SERVER_LOGFILE, "AbilityGather: not find obj=%d", ItemBoxObjID ) ;
		return OR_INVALID_TARGET ;
	}
	...
	if( pItemBox->GetObjType()!= Obj::OBJ_TYPE_ITEM_BOX)
	{
		Log::SaveLog( SERVER_LOGFILE, "AbilityGather: Obj_ItemBox obj	=	%d\r\n  is Not class of ITEM_CLASS_BOX", ItemBoxObjID ) ;
		return OR_INVALID_TARGET ;
	}
