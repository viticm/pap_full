...
//---------------------------------------------------------------------------
// 函数:	FoxLuaScript::GetValuesFromStack
// 功能:	从堆栈中获得变量
// 参数:	char * cFormat
// 参数:	...
// 返回:	BOOL 
...
//---------------------------------------------------------------------------
// 函数:	FoxLuaScript::RegisterFunction
// 功能:	注册某内部C函数至脚本中
// 参数:	LPSTR FuncName  在脚本中使用的函数名
// 参数:	void* Func    实际相应的C函数指针
// 参数:	int Args = 0 //与FoxScript接口相容，无用
// 参数:	int Flag = 0 //与FoxKScript接口相容, 无用
// 返回:	BOOL 
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
// 函数:	FoxLuaScript::RegisterFunctions
...
//---------------------------------------------------------------------------
// 函数:	FoxLuaScript::RegisterStandardFunctions
// 功能:	注册Lua系统标准的函数库
// 返回:	void 
//---------------------------------------------------------------------------
