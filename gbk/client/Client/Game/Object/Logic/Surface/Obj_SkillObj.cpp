...
//
//KL_IMPLEMENT_DYNAMIC(CObject_SkillObj, GETCLASS(CObject_Effect));
...
//			FLOAT fDistSq = KLU_GetDistSq( fvTarget, GetPosition() );
//			FLOAT fDir = KLU_GetYAngle( fVector2( GetPosition().x, GetPosition().z ), fVector2( fvTarget.x, fvTarget.z ) );
