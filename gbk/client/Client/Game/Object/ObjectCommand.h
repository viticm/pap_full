...
enum ENUM_OBJECT_COMMAND
{
	...
	OBJECT_COMMAND_MAGIC_PREP_SEND,		// 发招准备	//test2
	...
	OBJECT_COMMAND_BEATBACK,			// 被击
	OBJECT_COMMAND_CADAVER,				// 尸体

//	OBJECT_COMMAND_MOVE_SEND,			// 移动攻击
//	OBJECT_COMMAND_BEATBACK,			// 被击
...
private:
	...
	INT			m_nMagicID;									// 法术ID
	INT			m_nTargetNum;								// 目标数量
	ObjID_t		m_nTargetObjID[MAGICSEND_MAX_TARGET_NUM];	// 目标角色
	WORLD_POS	m_posTarget;								// 目标位置
	FLOAT		m_fTargetDir;								// 目标方向
};
