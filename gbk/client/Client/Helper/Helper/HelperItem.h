...
public:
	...
	*************************************************************************/
	CHelperItem(const WString& strName, const String& strAnchor="", const String& strUrl="");
	virtual ~CHelperItem();
	...
	*************************************************************************/
	...
	\brief
		Get Name.
	*/
	const WString& GetName(void) const { return m_strName; }
...
protected:
	WString			m_strName;		// The name of this item to display. Required!
