/*
** $Id: ldo.c,v 1.1 2006/03/17 08:47:35 chaojin Exp $
...
#if LUA_REFCOUNT
  {
    StkId stackpos = L->top;
    while (stackpos < L->stack_last)
      setnilvalue2n(stackpos++);
  }
#endif LUA_REFCOUNT
}
...
static void adjust_varargs (lua_State *L, int nfixargs, StkId base) {
  ...
  setsvalue2n(&nname, luaS_newliteral(L, "n"));
