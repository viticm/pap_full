/*
** $Id: lstate.h,v 1.1 2006/03/17 08:47:35 chaojin Exp $
** Global State
...
/* expanded per type metatables */
#define defaultmetatypes(L, num) (&G(L)->_defaultmetatypes[num])
...
typedef struct global_State {
  ...
  GCheader rootudata_head;
  GCheader rootudata_tail;
...
#define gcototws(o)	check_exp((o)->gch.tt == LUA_TWSTRING, &((o)->ts))
