...
x215013_g_Name	="忽都虎"
x215013_g_Name2	="成吉思汗" 
--x215013_g_DemandItem ={{id=13010003,num=1}}
--x215013_g_noDemandKill ={{id=301,num=1}}	

x215013_g_MissionName="第一次败仗"
x215013_g_MissionInfo="    我对不起大汗，大汗封我为大断事官，负责断案，建章立制，治世理政等，而我却一时兴起，要带兵打过仗，这一丈我们失败了，伤亡惨重！\n \n    虽然我们能拼死突围出来，但是……那些被俘虏的将士们，一个个被扎兰丁钉在木桩上，那惨叫声让我这一辈子都无法忘怀。\n \n    我只是一个文官的料，唉……！\n \n    我很痛苦，这是我们蒙古大军第一次战斗失败，都是我的错，虽然大汗没有责怪我，但是我心里十分不安，今天我要跟你道别了，回大草原去做我应该做的事。请你帮我把这封信送去给大汗，我无颜见到他！"  --任务描述
x215013_g_MissionTarget="    忽都虎向你道别，他要回大草原去了，请你帮他把信交给#G成吉思汗#W。"		
x215013_g_MissionComplete="    我能感受到六弟的痛苦！这事不能怪他，都是我用人不当，把乌鲁派去给他做助手，唉……"					--完成任务npc说话的话
--x215013_g_ContinueInfo="    不管付出多大代价，也要把那件东西给拿回来。"
--任务奖励
...
function x215013_OnDefaultEvent(sceneId, selfId, targetId)	--点击该任务后执行此脚本
...
function x215013_OnAccept(sceneId, selfId)
	...
	AddText(sceneId,"接受任务："..x215013_g_MissionName) 
	EndEvent()
...
function x215013_OnAbandon(sceneId, selfId)
	...
	for i, item in x215013_g_DemandItem do
...
function x215013_OnSubmit(sceneId, selfId, targetId, selectRadioId)
	...
	if DelMission(sceneId, selfId, x215013_g_MissionId) > 0 then
		...
		for i, item in x215013_g_RadioItemBonus do
