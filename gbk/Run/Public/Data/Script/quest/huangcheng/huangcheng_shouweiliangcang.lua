...
function	x300304_ShowQuestInfo( sceneId, selfId, targetId ,Done)
	...
	if DoneEX==2 then
		for i, Info in x300304_g_ContinueInfo do
			AddText(sceneId,Info)
		end
	else
		for i, Info in x300304_g_MissionInfo do
			AddText(sceneId,Info)
		end
	end
	...
	if DoneEX == 2 then
		...
		if x300304_g_ItemBonus ~= nil then
			for i, item in x300304_g_ItemBonus do
				AddItemBonus( sceneId, item.id, item.num )
			end
		end			
		if x300304_g_RadioItemBonus ~= nil then
			for i, item in x300304_g_RadioItemBonus do
...
function	x300304_ShowQuestAim( sceneId, selfId, targetId ,Done)
	...
	if x300304_g_Quest ==nil then
		...
		for i, QuestInfo in x300304_g_Quest do
