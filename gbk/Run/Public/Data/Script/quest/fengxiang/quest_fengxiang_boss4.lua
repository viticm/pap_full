...
--任务是否已经完成
x910008_g_IsMissionOkFail = 0		--变量的第0位

--任务需要收集的物品
x910008_g_DemandItem ={{id=30007007,num=1}}		--变量第1位

--以上是动态**************************************************************

--任务文本描述
x910008_g_MissionName="收集蒙古护腕碎片"
x910008_g_MissionInfo="Boss1身上有蒙古护腕碎片，拿来我可以给你换副好的护腕！"  --任务描述
x910008_g_MissionTarget="拿来蒙古护腕碎片"		--任务目标
x910008_g_ContinueInfo="你有蒙古护腕碎片吗？"		--未完成任务的npc对话
x910008_g_MissionComplete="给你这副好的护腕！"					--完成任务npc说话的话
...
--任务入口函数
--**********************************
function x910008_OnDefaultEvent( sceneId, selfId, targetId )	--点击该任务后执行此脚本
...
function x910008_OnAccept( sceneId, selfId )
	--加入任务到玩家列表
	AddMission( sceneId,selfId, x910008_g_MissionId, x910008_g_ScriptId, 1, 0, 0 )		--添加任务
	misIndex = GetMissionIndexByID(sceneId,selfId,x910008_g_MissionId)			--得到任务的序列号
