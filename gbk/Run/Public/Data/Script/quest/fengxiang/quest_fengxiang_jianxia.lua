...
--任务入口函数
--**********************************
function x910018_OnDefaultEvent( sceneId, selfId, targetId )	--点击该任务后执行此脚本
	BeginEvent(sceneId)
			...
			if ret > 0 then
				...
				if ret > 0 then
					AddItemListToHuman(sceneId,selfId)
					BeginEvent(sceneId)
						strText = "你获得了一套90级声望装"
						AddText(sceneId,strText);
					EndEvent(sceneId)
					DispatchMissionTips(sceneId,selfId)	
					AddText(sceneId,"这是90级声望装，你收好了！")
				else
				--职业物品没有加成功
					BeginEvent(sceneId)
