...
x700004_g_CopySceneName				= "xinshoucun_02"
x700004_g_Name								= ""
x700004_g_CopySceneType				= xinshoucun_02
...
x700004_g_Fuben_X							= 63				--进入副本的位置X
x700004_g_Fuben_Z							= 69				--进入副本的位置Z
x700004_g_Back_X							= 165				--源场景位置X
x700004_g_Back_Z							= 154					--源场景位置Z

x700004_g_BossType						= 300

x700004_g_FailedObj						= {type=9034, x=63, z=66, ai=7, aiscript=0, camp=24}
x700004_g_NeedKillMonster			= {
																	{hash=1, num=5, type=9031, time=3, pos=1, ai=0, aiscript=0},
																	{hash=1, num=5, type=9031, time=4, pos=1, ai=0, aiscript=0},
																	{hash=2, num=5, type=9031, time=12, pos=3, ai=0, aiscript=0},
																	{hash=2, num=5, type=9031, time=13, pos=3, ai=0, aiscript=0},
																	{hash=3, num=5, type=9032, time=21, pos=2, ai=0, aiscript=0},
																	{hash=3, num=5, type=9032, time=22, pos=2, ai=0, aiscript=0},
																	{hash=4, num=6, type=9032, time=33, pos=4, ai=0, aiscript=0},
																	{hash=4, num=6, type=9032, time=34, pos=4, ai=0, aiscript=0},
																	{hash=5, num=10, type=9031, time=45, pos=1, ai=0, aiscript=0},
																	{hash=5, num=10, type=9032, time=45, pos=3, ai=0, aiscript=0},
																	{hash=6, num=10, type=9033, time=69, pos=4, ai=0, aiscript=0},
																	{hash=7, num=5, type=9033, time=84, pos=2, ai=0, aiscript=0},
																	{hash=7, num=5, type=9033, time=85, pos=2, ai=0, aiscript=0},
																	{hash=7, num=5, type=9033, time=86, pos=2, ai=0, aiscript=0},
																	{hash=8, num=8, type=9031, time=99, pos=1, ai=0, aiscript=0},
																	{hash=8, num=8, type=9032, time=99, pos=3, ai=0, aiscript=0},
																	{hash=8, num=8, type=9033, time=99, pos=4, ai=0, aiscript=0},
																	{hash=9, num=10, type=9032, time=135, pos=2, ai=0, aiscript=0},
																	{hash=9, num=10, type=9033, time=135, pos=4, ai=0, aiscript=0},
																	{hash=10, num=1, type=9030, time=142, pos=1, ai=0, aiscript=0},
																	--{hash=10, num=1, type=9031, time=12, pos=3, ai=0, aiscript=0},
																	--{hash=10, num=1, type=9032, time=12, pos=1, ai=0, aiscript=0},
																	--{hash=11, num=1, type=9031, time=13, pos=2, ai=0, aiscript=0},
																	--{hash=11, num=1, type=9033, time=13, pos=4, ai=0, aiscript=0},
																	--{hash=12, num=1, type=x700004_g_BossType, time=14, pos=1, ai=0, aiscript=0}
																}
x700004_g_RandomBirthPosition	=	{
																	{hash=1, x=21, z=31, r=2, patrolSetId=1, camp=21},
																	{hash=2, x=104, z=28, r=2, patrolSetId=2, camp=21},
																	{hash=3, x=104, z=100, r=2, patrolSetId=3, camp=21},
																	{hash=4, x=30, z=100, r=2, patrolSetId=4, camp=21}
																}
...
x700004_g_LevelLess					= 45
x700004_g_StartCreateDelay	= 1

x700004_g_MissionName				= "东海海眼"
x700004_g_MissionInfo				= "杀死全部怪物，解救赵公明！"
...
x700004_g_CompleteFailedNPCMessage	= "你们竟然失败了！"
x700004_g_TipForEnter						= format("%d分钟后开始刷怪。", x700004_g_StartCreateDelay)
x700004_g_SceneMapNavPath				= "xinshoucun_02/xinshoucun_02.nav"
