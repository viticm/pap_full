...
x400006_g_scriptId = 400006 
x400006_g_Impact1 = 3001 
...
--事件交互入口
--**********************************
function x400006_OnDefaultEvent( sceneId, selfId, bagIndex )
-- 不需要这个接口，但要保留空函数
end
...
function x400006_OnDeplete( sceneId, selfId )
	...
	BeginEvent(sceneId)
	AddText(sceneId,format("埋放蒙哥的炸药   %d/1", GetMissionParam(sceneId,selfId,misIndex,0)))
	DispatchMissionTips(sceneId,selfId) 
	return 1
