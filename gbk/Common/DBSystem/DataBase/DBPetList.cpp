...
BOOL DBPetList::Save(VOID* pSource)
{
	...
	for(INT i = 0;i <HUMAN_PET_MAX_COUNT;i++)
	{
		...
		pQuery->Parse(NewCharPet,
					  ...
					  PetCamp,
					  //pCharFullData->m_PetList.m_aPetDB[i].m_nHP,// [6/5/2008 wuwenbin]
					  //0,// [6/5/2008 wuwenbin]
					  //pCharFullData->m_PetList.m_aPetDB[i].m_nLife,	// [6/5/2008 wuwenbin]
					  
					  (INT)pCharFullData->m_PetList.m_aPetDB[i].m_byGeneration,	
					  (INT)pCharFullData->m_PetList.m_aPetDB[i].m_byHappiness,	
					  pCharFullData->m_PetList.m_aPetDB[i].m_iStrengthPerception ,	
					  pCharFullData->m_PetList.m_aPetDB[i].m_iSmartnessPerception	,
					  pCharFullData->m_PetList.m_aPetDB[i].m_iMindPerception	,

					  pCharFullData->m_PetList.m_aPetDB[i].m_iConstitutionPerception	,
	...
	case DB_LOAD:
		{
			...
			//	pCharFullData->m_PetList.m_aPetDB[i].m_nMP			// [6/5/2008 wuwenbin]
			//		=	mInterface->GetInt(DB_MP,ErrorCode);
				//pCharFullData->m_PetList.m_aPetDB[i].m_nLife			// [6/5/2008 wuwenbin]
				//	=	mInterface->GetInt(DB_Life,ErrorCode);
				//pCharFullData->m_PetList.m_aPetDB[i].m_byPetType		// [6/5/2008 wuwenbin]
