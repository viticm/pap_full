...
//
//修改情况：	2005.3.2 创建文件
//				2005.3.9 Version 1.0.0 完成基本功能
//				2005.3.25 Version 1.0.1 添加GUID_t GameDefine.h 等内容
//				2005.11.1 修改内容，加入BaseType.h 等内容
//
...
typedef ID_t			TopListID_t;		//排行榜ID

//by soongxl
typedef ID_t           CountryID_t;     //国家ID
typedef ID_t           JiaZuID_t;// 家族ID
