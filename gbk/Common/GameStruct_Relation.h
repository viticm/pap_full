...
enum RELATION_REQUEST_TYPE
{
	...
	REQ_VIEWPLAYER,										// 查看玩家
	REQ_ADDFRIEND,
	REQ_ADDTOBLACKLIST,									// 添家到黑名单
	REQ_ADDTOENEMY,										// 添加到敌人
	REQ_TEMPFRIEND_TO_FRIEND,
	REQ_TEMPFRIEND_ADDTO_BLACKLIST,
	REQ_TEMPFRIEND_ADDTO_ENEMY,							// 转移到敌人
	REQ_TRANSITION,
	REQ_DELFRIEND,										// 删除好友
	REQ_DELFROMBLACKLIST,								// 删除黑名单
	REQ_DELFROMENEMY,									// 删除敌人
	...
	REQ_ADD_NEW_GROUP,									// 请求创建新组
	REQ_DEL_GROUP,										// 请求删除组
	REQ_SUREADDFRIEND,									// 确认加为好友
	REQ_REJECTADDFRIEND,								// 拒绝加为好友邀请
	REQ_DELFRIENDBYMAIL,								// 删除好友，通过可执行邮件
	REQ_FRIENDADDPOINT,									// 向word更新好友度信息
};
...
enum RELATION_RETURN_TYPE
{
	...
	RET_ADDFRIEND,
	RET_ADDTOBLACKLIST,
	RET_ADDENEMY,										// 通知玩家对方已经被加入到仇人中
	RET_TEMPFRIEND_TO_FRIEND,
	RET_TEMPFRIEND_ADDTO_BLACKLIST,
	RET_TRANSITION,
	RET_DELFRIEND,
	RET_DELFROMBLACKLIST,								// 通知删除黑名单
	RET_DELFROMENEMY,									// 同志删除敌人
	RET_ADDFRIENDNOTIFY,								// 通知好友已经被加了
	RET_ASKADDFRIEND,									// 通知玩家是否同意被邀请为好友
	RET_ASKADDTOBLACKLIST,								// 通知玩家已经成功将对方移动到黑名单
	RET_ASKTHROWTOFRIENDLIST,							// 通知玩家已经成功将对方移动到好友列表
	...
	RET_NEW_GROUP,										//	添加新组
	RET_REJECTADDFRIEND,								// 通知邀请人拒绝接受加为好友邀请
	RET_FRIENDADDPOINT,									// 通知增加好友度
	RET_DELFRIENDBYMAIL,								// 通过可执行邮件删除好友
	RET_DELFRIENDFORADDENEMY,							// 在加为仇人时，通知server和客户端删除好友

	RET_ERR_START,
	RET_ERR_TARGETNOTEXIST,								// 目标不存在或不在线
	RET_ERR_GROUPISFULL,								// 组已满
	...
	RET_ERR_FRIENDGROUPISFULL,							// 好友组已经满员			
	RET_ERR_BLACKGROUPISFULL,							// 黑名单组已经满员
...
{
	//数据
	UCHAR								m_uNameSize;						// 组名长度
	CHAR								m_szGroupName[MAX_GROUP_NAME];		// 组名
	INT									m_uGroupID;							// 组ID
