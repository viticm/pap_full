// GWDetailOtherOnlineAttrib_Human.cpp
// 
/////////////////////////////////////////////////////
...
namespace Packets
{
	...
	BOOL GWDetailOtherOnlineAttrib_Human::Read( SocketInputStream& iStream ) 
	{
		__ENTER_FUNCTION
	...
	BOOL GWDetailOtherOnlineAttrib_Human::Write( SocketOutputStream& oStream ) const
	{
		__ENTER_FUNCTION
	...
	/*
	VOID GWDetailOtherOnlineAttrib_Human::FillParamBuf( VOID *pBuf )
	{
	UINT *aBuf	= (UINT*)(pBuf);
	...
	*/
	UINT GWDetailOtherOnlineAttrib_Human::Execute( Player* pPlayer )
	{
		__ENTER_FUNCTION

			return GWDetailOtherOnlineAttrib_HumanHandler::Execute( this, pPlayer ) ;
	...
	VOID GWDetailOtherOnlineAttrib_Human::SetTargetID( ObjID_t objID )
	{
		m_TargetID = objID;
	}
