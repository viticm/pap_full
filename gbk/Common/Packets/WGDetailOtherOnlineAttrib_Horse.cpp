// WGDetailOtherOnlineAttrib_Horse.cpp
// 
/////////////////////////////////////////////////////
...
namespace Packets
{
	BOOL WGDetailOtherOnlineAttrib_Horse::Read( SocketInputStream& iStream ) 
	{
		__ENTER_FUNCTION
	...
	BOOL WGDetailOtherOnlineAttrib_Horse::Write( SocketOutputStream& oStream )const
	{
		__ENTER_FUNCTION
	...
	UINT WGDetailOtherOnlineAttrib_Horse::Execute( Player* pPlayer )
	{
		__ENTER_FUNCTION

			return WGDetailOtherOnlineAttrib_HorseHandler::Execute( this, pPlayer ) ;
	...
	const CHAR* Packets::WGDetailOtherOnlineAttrib_Horse::GetName( VOID ) const
	{
		return m_szName;
	}

	const CHAR* Packets::WGDetailOtherOnlineAttrib_Horse::GetNickName() const
	{
		return m_szNickName;
	}
}
