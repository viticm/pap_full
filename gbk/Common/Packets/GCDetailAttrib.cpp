...
__ENTER_FUNCTION
	...
	*/
	...
	if ( m_Flags.isSetBit(DETAIL_ATTRIB_GUID))
		iStream.Read( (CHAR*)(&m_nGuid), sizeof(m_nGuid));
    ...
    //  [7/23/2010 ³Â¾üÁú]
	if ( m_Flags.isSetBit(DETAIL_ATTRIB_MOUNTINDEX))
		iStream.Read( (CHAR*)(&m_nMountIndex), sizeof(m_nMountIndex));
...
__ENTER_FUNCTION
	...
	if ( m_Flags.isSetBit(DETAIL_ATTRIB_GUID))
		oStream.Write( (CHAR*)(&m_nGuid), sizeof(m_nGuid));
    ...
    //  [7/23/2010 ³Â¾üÁú]
	if ( m_Flags.isSetBit(DETAIL_ATTRIB_MOUNTINDEX))
		oStream.Write( (CHAR*)(&m_nMountIndex), sizeof(m_nMountIndex));
...
VOID GCDetailAttrib::SetTargetID( ObjID_t objID )
{
	m_TargetID = objID;
}