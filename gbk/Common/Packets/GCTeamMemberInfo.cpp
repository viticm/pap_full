...
__ENTER_FUNCTION
	...
	if( IsUpdateAttrib(TEAM_MEMBER_ASSIHAND) )
	{
		iStream.Read( (CHAR*)&m_AssihandID, sizeof(UINT) );
	}
	...
	if( IsUpdateAttrib(TEAM_MEMBER_ATT_SCAPULAR) )
	{
		iStream.Read( (CHAR*)&m_ScapularID, sizeof(UINT) );
	}
...
__ENTER_FUNCTION
	...
	if( IsUpdateAttrib(TEAM_MEMBER_ASSIHAND) )
	{
		oStream.Write( (CHAR*)&m_AssihandID, sizeof(UINT) );
	}
	...
	if( IsUpdateAttrib(TEAM_MEMBER_ATT_SCAPULAR) )
	{
		oStream.Write( (CHAR*)&m_ScapularID, sizeof(UINT) );
	}
