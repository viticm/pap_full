#ifndef _GWDetailOtherOnlineAttrib_Horse_H_
#define _GWDetailOtherOnlineAttrib_Horse_H_
...
namespace Packets
{
	...
	//	HorseState_Mating
	//};
	class GWDetailOtherOnlineAttrib_Horse :
		public Packet
	{
	public:
		GWDetailOtherOnlineAttrib_Horse( ){
		...
		virtual ~GWDetailOtherOnlineAttrib_Horse( ){}
		...
		virtual PacketID_t		GetPacketID()const { return PACKET_GW_DETAILOTHERONLINEATTRIB_HORSE; }
		virtual UINT			GetPacketSize()const 
		{
			UINT uSize = sizeof(PET_GUID_t) + sizeof(Flag64) + sizeof(INT) + sizeof(INT) + sizeof(GUID_t);
			UINT i;
	...
	public:
		...
		VOID					SetSkill( UINT uIndex, const _PET_SKILL *pSkill )
		{
			...
			{
				Assert( (pSkill != NULL && uIndex < PET_MAX_SKILL_COUNT) && "GWDetailOtherOnlineAttrib_Horse::SetSkill" );
			}
		}
	...
	class GWDetailOtherOnlineAttrib_HorseFactory : public PacketFactory 
	{
	public:
		Packet*		CreatePacket() { return new GWDetailOtherOnlineAttrib_Horse() ; }
		PacketID_t	GetPacketID()const { return PACKET_GW_DETAILOTHERONLINEATTRIB_HORSE; }
		UINT		GetPacketMaxSize()const
		{
			UINT uSize = sizeof(GWDetailOtherOnlineAttrib_Horse) - sizeof(Packet) ;
			return uSize;
		}
	};

	class GWDetailOtherOnlineAttrib_HorseHandler 
	{
	public:
		static UINT Execute( GWDetailOtherOnlineAttrib_Horse* pPacket, Player* pPlayer ) ;
	};
