...
__ENTER_FUNCTION
	...
	iStream.Read( (CHAR*)(&m_nCountry), sizeof(INT) ) ;
	iStream.Read( (CHAR*)(&m_nProfession), sizeof(INT) ) ;
	iStream.Read( (CHAR*)(&m_nFaceModel), sizeof(INT) ) ;
...
__ENTER_FUNCTION
	...
	oStream.Write( (CHAR*)(&m_nCountry), sizeof(INT) ) ;
	oStream.Write( (CHAR*)(&m_nProfession), sizeof(INT) ) ;
	oStream.Write( (CHAR*)(&m_nFaceModel), sizeof(INT) ) ;
