#ifndef _GWDetailOtherOnlineAttrib_Human_H_
#define _GWDetailOtherOnlineAttrib_Human_H_
...
namespace Packets
{
	...
	class GWDetailOtherOnlineAttrib_Human :
		public Packet
	{
	public:
		GWDetailOtherOnlineAttrib_Human( )
		{
			m_Flags.CleanUp();
			m_TargetID = 0;
		}
		virtual ~GWDetailOtherOnlineAttrib_Human( ){}
		...
		virtual PacketID_t		GetPacketID()const { return PACKET_GW_DETAILOTHERONLINEATTRIB_HUMAN ; }
		virtual UINT			GetPacketSize()const 
		{
			UINT uSize = sizeof(ObjID_t) + sizeof(Flag128) + sizeof(GUID_t);
			UINT i;
	...
	class GWDetailOtherOnlineAttrib_HumanFactory : public PacketFactory 
	{
	public:
		Packet*		CreatePacket() { return new GWDetailOtherOnlineAttrib_Human() ; }
		PacketID_t	GetPacketID()const { return PACKET_GW_DETAILOTHERONLINEATTRIB_HUMAN; }
		UINT		GetPacketMaxSize()const { return	sizeof(GWDetailOtherOnlineAttrib_Human) - sizeof(Packet); }

	};

	class GWDetailOtherOnlineAttrib_HumanHandler 
	{
	public:
		static UINT Execute( GWDetailOtherOnlineAttrib_Human* pPacket, Player* pPlayer ) ;
	};
