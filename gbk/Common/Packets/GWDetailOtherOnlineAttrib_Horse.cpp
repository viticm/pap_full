// GWDetailOtherOnlineAttrib_Horse.cpp
// 
/////////////////////////////////////////////////////
...
namespace Packets
{
	BOOL GWDetailOtherOnlineAttrib_Horse::Read( SocketInputStream& iStream ) 
	{
		__ENTER_FUNCTION
	...
	BOOL GWDetailOtherOnlineAttrib_Horse::Write( SocketOutputStream& oStream )const
	{
		__ENTER_FUNCTION
	...
	UINT GWDetailOtherOnlineAttrib_Horse::Execute( Player* pPlayer )
	{
		__ENTER_FUNCTION

			return GWDetailOtherOnlineAttrib_HorseHandler::Execute( this, pPlayer ) ;
	...
	const CHAR* Packets::GWDetailOtherOnlineAttrib_Horse::GetName( VOID ) const
	{
		return m_szName;
	}

	const CHAR* Packets::GWDetailOtherOnlineAttrib_Horse::GetNickName() const
	{
		return m_szNickName;
	}
}
