...
BOOL WGDetailOtherOnlineEquipList_Human::Read( SocketInputStream& iStream ) 
{
	__ENTER_FUNCTION
...
BOOL WGDetailOtherOnlineEquipList_Human::Write( SocketOutputStream& oStream )const
{
	__ENTER_FUNCTION
...
UINT	WGDetailOtherOnlineEquipList_Human::Execute( Player* pPlayer )
{
	__ENTER_FUNCTION

		return WGDetailOtherOnlineEquipList_HumanHandler::Execute( this, pPlayer ) ;
