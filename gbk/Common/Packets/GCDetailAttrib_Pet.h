...
namespace Packets
{
	...
	enum ENUM_PET_DETAIL_ATTR
	{
		...
		PET_DETAIL_ATTR_ATT_NEAR,				//近程外功攻击力
		PET_DETAIL_ATTR_ATT_FAR,					//远程外功攻击力

		PET_DETAIL_ATTR_ATT_MAGIC_NEAR,		// 近程内功攻击力
		PET_DETAIL_ATTR_ATT_MAGIC_FAR,		// 远程程内功攻击力
		//PET_DETAIL_ATTR_DEF_PHYSICS,		// 物理防御力
		PET_DETAIL_ATTR_DEF_NEAR,				// 近程外功防御力
		PET_DETAIL_ATTR_DEF_FAR,					//远程外功防御力

		PET_DETAIL_ATTR_DEF_MAGIC_NEAR,		// 近程内功防御力
		PET_DETAIL_ATTR_DEF_MAGIC_FAR,		// 远程内功防御力
