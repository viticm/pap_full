...
namespace Packets
{
	...
	public:
		...
		{
			return sizeof(SceneID_t) + sizeof(ID_t) + sizeof(BYTE)*2 + m_bExtraLength; 
		}
	...
	public:
		...
		UINT		GetPacketMaxSize()const { return sizeof(SceneID_t) + MAX_EXTRAINFO_LENGTH + sizeof(BYTE)*2 + sizeof(ID_t); }
	};
