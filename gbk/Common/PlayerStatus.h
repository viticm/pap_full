...
enum PLAYER_STATUS
{
	...
	PS_LOGIN_WAIT_REG_PASSPORT,		//等待clinet 发送PassPort信息
	PS_LOGIN_WAIT_REG_RESULT,		//等待login 验证PassPort
	...
	PS_LOGIN_WAIT_WORLD_KICK,		//等待World踢人结果
	PS_LOGIN_WAIT_WORLD_ASK,		//等待World查询结果
	PS_LOGIN_WORLD_PROCESS_TURN,	//已经选择好人物在等待进入World
	PS_LOGIN_WAIT_LICENSE_CLIENT,	//等待客户端发送注册新协议
	PS_LOGIN_WAIT_LICENSE_RESULT,	//等待Billing验证注册新协议的结果
	PS_LOGIN_WAIT_SAFESIGN_CLIENT,	//等待客户端确认安全协议

	PS_LOGIN_PROCESS_OVER_TURN,		//LOGIN排队人数达到上限后登录的玩家
