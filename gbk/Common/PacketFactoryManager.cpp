...
#include "CGStallOpen.h"	// 玩家摊位开市	20100706 BLL
...
#include "GCCharUseSkill.h" // 使用技能成功回送包	
...
#include "GCStallOpenPublic.h"	// 玩家摊位开市		20100706 BLL
...
//CG
	...
	AddFactory( new CGAskDetailMountListFactory() );               // [7/8/2010 陈军龙]
...
//GC
	...
	AddFactory( new GCCharUseSkillFactory()) ;  // 对象使用技能，用于头顶冒技能名称 20100602 BLL
	...
	AddFactory( new CGManipulateMountFactory);        // [7/8/2010 陈军龙]
	AddFactory( new GCManipulateMountResultFactory);  // [7/8/2010 陈军龙]
	AddFactory( new GCDetailMountListFactory() );     // [7/8/2010 陈军龙]
#endif
